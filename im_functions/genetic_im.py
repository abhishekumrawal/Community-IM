...
def genetic_im(network, weighting_scheme, budget, diffusion_model, n_sim, all_upto_budget=True):
    ...
    """pruning based on centrality measures"""
    "centarlity measures"
    ...
    "ranked nodes using total centrality"
    ...
    "number of vertices in the network and proportion of nodes to be kept after pruning"
